...
Additionally, the application/system must have mechanism in place to prevennt attackers from extending transactions over an "acceptable" amount of time. This may be done by canceling or resetting transactions after a specified amount of time has passed like some ticket vendors are now using.
